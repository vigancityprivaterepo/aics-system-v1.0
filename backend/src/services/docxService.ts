...
function buildRenderData(caseData: any): Record<string, any> {
  ...
  return {
    ...
    reqBurialCertificateIndigency: checkbox(isHospital && isReqSubmitted('indigency')),
    reqHospitalPhotocopyId: checkbox(isBurial && isReqSubmitted('id_copy')),
    ...
    reqBurialPhotocopyId: checkbox(isHospital && isReqSubmitted('id_copy')),
