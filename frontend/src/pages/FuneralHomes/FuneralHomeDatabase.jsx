      ...
      {showForm && (
        <Modal onClose={() => { setShowForm(false); setEditing(null); resetForm() }}>
            <div className="rounded-t-2xl bg-gradient-to-r from-[#064e3b] to-[#065f46] px-6 py-4 flex items-center justify-between">
              <h2 className="font-display text-lg font-bold text-white">{editing ? 'Edit Funeral Home' : 'Add New Funeral Home'}</h2>
            ...
            <div>
              ...
              <div className="flex justify-end gap-3 pt-2 border-t border-slate-100">
                ...
                <button onClick={handleSave} className="portal-button-primary" type="button">Save</button>
              </div>
            </div>
        </Modal>
      )}
