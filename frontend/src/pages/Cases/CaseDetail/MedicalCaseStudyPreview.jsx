...
const DOCS = [
  { key: 'case-study',       label: 'Medical Case Study', endpoint: (id) => `/cases/${id}/report/docx`,    downloadLabel: 'case-study' },
...
export default function MedicalCaseStudyPreview({ caseData }) {
