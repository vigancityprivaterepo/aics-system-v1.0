...
export default function VehicleRequestsPage() {
  ...
  const [requests, setRequests] = useState([]), [options, setOptions] = useState({}), [search, setSearch] = useState(''), [status, setStatus] = useState(''), [editing, setEditing] = useState(undefined), [reviewing, setReviewing] = useState(null), [previewing, setPreviewing] = useState(null), [loading, setLoading] = useState(true)
